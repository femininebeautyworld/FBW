			...
			<div class="header_container">
				...
				<div class="header_menu">
					<ul class="menu" id="main_header_menu">
						...
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20" id="menu-item-20"><a
							href="<%=RequestUtils.getBaseURI(request)%>/homePage.do?method=fetchResultsByPostType&postType=celebrity">Celebrity Fashion</a></li>
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-21" id="menu-item-21"><a
						...
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-23" id="menu-item-23"><a href="<%=RequestUtils.getBaseURI(request)%>/contactUs.do?method=display">Contact</a></li>
					</ul>
				</div>
				<!--//header_menu-->
